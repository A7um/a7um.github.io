...
abstract: >
  By 2025, our systems had automatically uncovered more than 60 real-world vulnerabilities across cryptographic libraries, AI frameworks, and cloud services. Looking back, we found that **our success came not from a single technical breakthrough, but from correctly tracking paradigm shifts in AI and adapting our methods at each transition**. At the same time, we observed many top-tier papers gradually losing real-world impact as they failed to adapt to those shifts. This article is our attempt to make that pattern explicit: we trace three paradigm transitions in automated vulnerability discovery from 2022 to 2025—moving from "LLMs as classifiers" to "LLMs augmenting fuzzers and static analyzers" to "agentic, tool-using auditors"—and discuss how understanding these shifts can help you make research and engineering bets that survive across paradigms.
---

By 2025, our system had automatically discovered more than 60 real‑world security vulnerabilities. These span three domains: cryptographic libraries, AI frameworks, and cloud services. In cryptography, we found over a dozen issues in mainstream libraries such as Rust‑Crypto, BouncyCastle, and gnark, including private‑key recovery (CVE‑2026‑22698, CVSS 8.7), key‑reuse leading to plaintext recovery (CVE‑2025‑14813, CVSS 8+), and signature malleability (CVE‑2025‑57801, CVSS 9.1). In AI, we uncovered more than ten remote code execution vulnerabilities in frameworks such as MaxB, Flowise, and Ragflow, including arbitrary file‑write RCE (CVE‑2025‑61913, CVSS 9.9) and information‑leak plus SSRF chains leading to RCE (CVE‑2025‑64703, CVE‑2025‑64511). In cloud security, we also identified over ten serious issues in products such as Tyk, which are currently under responsible disclosure.
