...
1. **禁止手写代码。**
2. **禁止盯着看 AI 写代码。**
3. **禁止在代码编辑器里 review AI 写的代码。**

每一条第一次说出来，都会有人觉得我在开玩笑。但这三条在我们团队已经跑了几个月——没崩，反而是过去两年里效率变化最明显的一次。

为什么这三条不是胡闹，是本文接下来要讲的事。

> **TL;DR：** 让 AI 并行开发的真正门槛不是模型能力，而是能不能把"需求对齐 / 正确性验证 / 架构把控"这三件今天还得人做的事，改造成 Agent 自主能做的闭环。
