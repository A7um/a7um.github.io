...
如果这个比赛是面向新手玩家，如高效的校赛，那我建议一初级赛题或中级赛题为主，因为对于新手而言，初级赛题和中级赛题已足以引导他们学习新的知识。
如果这个比赛是面向的既有经验丰富的战队又有在成长期的新星战队，则需要自系调配不同类型的赛题以控制好比赛的整体难度。
如果这个比赛是面向国际顶级战队如DEFCON外卡赛，则建议以高级赛题和顶级赛题为主。
