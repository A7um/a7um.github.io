...
This challenge is a ruby vm escape challenge,with a ruby C extension named LFA.so, which implements a 'safe' array(i.e. array with boundary check and dynamics length). This is my first time to play with a ruby vm escape challenge. and I solved this challenge under the situation that I am very unfamiliar with ruby. which is very fascinating for me.
...
After we get full address space access, it is not hard to get the flag. but I am not going to follow the standard way, I want to play in a different way: play with the fucking ruby heap and the fucking garbage collector, which is full of fengshui and xuanxue for me. because I never exploit ruby vm before and I want to play with it.
