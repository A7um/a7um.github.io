...
This challenge is a ruby vm escape challenge,with a ruby C extension named LFA.so, which implements a 'safe' array(i.e. array with boundary check and dynamics length). This is my first time to play with a ruby vm escape challenge. I solved this challenge under the situation that I am very unfamiliar with ruby, which is very fascinating for me. The process I solve this challenge is full of fengshui and xuanxue, haha.
